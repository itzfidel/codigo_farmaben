  ...
  function buscar_datos(consulta) {
      ...
      $.post('../controlador/UsuarioController.php',{consulta,funcion},(response)=>{
         ...
         usuarios.forEach(usuario=>{
             template+=`
             <div usuarioId="${usuario.id}"class="col-12 col-sm-6 col-md-3 d-flex align-items-stretch">
            <div class="card bg-light">
                ...
                <div class="row">
                  <div class="col-7">
                    ...
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                      ...
                      <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> movil #: ${usuario.movil}</li>
              ...
              if(tipo_usuario==3){
               if(usuario.tipo_usuario!=3){
                 template+=`
                 <button class="ascender btn btn-danger mr-1>
